...
<head>
    ...
    <link rel="stylesheet" href="/thirty/xterm/xterm.css" />
    <script type="application/javascript" src="/thirty/xterm/xterm.js"></script>
    <script type="application/javascript" src="/thirty/xterm/addons/attach/attach.js"></script>
</head>
<body>
        ...
        <c:if test="${not empty DOCKER_USER }">
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li id="li_containers"><a href="${ctx }/mgr/containers">容器</a></li>
                </ul>
